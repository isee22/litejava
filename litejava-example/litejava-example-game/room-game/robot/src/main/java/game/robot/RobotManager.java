...
public class RobotManager {
     ...
     * 快速开始 (有房间加入，没房间创建)
     * 
     * @return {status, roomid, ip, port, token, gameType} 或 null
     */
    public Map<String, Object> quickStart(long userId, String name, String gameType, int level) {
        try {
            String url = hallHttpUrl + "/quick_start";
            ...
            app.log.warn("快速开始失败: " + resp);
            return null;
        } catch (Exception e) {
            app.log.error("快速开始异常: " + e.getMessage());
            return null;
        }
    }
     ...
     */
    public Map<String, Object> startMatch(long userId, String name, String gameType, int level) {
        try {
